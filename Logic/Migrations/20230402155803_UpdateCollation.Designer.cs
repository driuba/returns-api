...
namespace Returns.Logic.Migrations
{
    ...
    [Migration("20230402155803_UpdateCollation")]
            ...
            modelBuilder.Entity("Returns.Domain.Entities.FeeConfiguration", b =>
                {
                    ...
                    b.HasIndex("CountryId", "CustomerId", "FeeConfigurationGroupId")
                        .IsUnique()
                        .HasFilter("[Deleted] = 0");

                    b.ToTable("FeeConfigurations", null, t =>
                        {
                            t.HasCheckConstraint("CK_FeeConfigurations_CountryId_CustomerId", "[CountryId] IS NULL OR [CustomerId] IS NULL");
                        });
                });
